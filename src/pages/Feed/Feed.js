...
class Feed extends Component {
    ...
    loadPosts = direction => {
        ...
        // the first use is string interpolation
        // the better alternative of using graphql query: use variables
        const graphqlQuery = {
            query: `
    ...
    finishEditHandler = postData => {
        ...
        // need to use FormData (browser provide this) because there are text and file
